...
@Component({
  selector: 'app-bussiness-emi-calculator',
  templateUrl: './bussiness-emi-calculator.component.html',
  styleUrls: ['./bussiness-emi-calculator.component.scss']
})
export class BussinessEmiCalculatorComponent {
  ngOnInit(): void {
    this.calculateEMI();
  }
  ...
  downloadPDF() {
    ...
    const header = () => {
      doc.setFontSize(12);
      doc.text('Business Loan EMI Breakdown', 10, 10);
      doc.setFontSize(10);
    ...
    doc.save('business-loan-emi-breakdown.pdf');
  }
  ...
  downloadCSV() {
    ...
    link.setAttribute('download', 'business-loan-emi-breakdown.csv');
    link.click();
  }
}
